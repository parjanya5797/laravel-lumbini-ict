...
Route::group(['middleware' => ['auth','validateRoute']],function(){
    ...
    Route::get('/todo/create','TodosController@add')->name('todo.create')->middleware('can:create,App\TodosList');
    Route::post('/todo/create','TodosController@store')->name('todo.store')->middleware('can:create,App\TodosList');
    ...
    // Route::get('/view-mail-layout',function(){
        ...
        //Response 
        Route::get('/response/text','ResponseController@text');
        Route::get('/response/array','ResponseController@array');
        Route::get('/response/object','ResponseController@object');
        Route::get('/response/json','ResponseController@json');
